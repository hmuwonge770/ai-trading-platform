...
class ReadinessEvidence:
    """Immutable evidence reference for one production-readiness gate."""
...
class ProductionReadinessReport:
    """Fail-closed production readiness result.

    Passing this report only makes a strategy LIVE_ELIGIBLE. It never arms,
    activates, or authorizes live capital.
    """
